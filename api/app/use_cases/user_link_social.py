...
from app.db.models import UserSocialNetwork as Model
from app.schemas.user_link_social import Request, Update, Response
from app.services.ids import id_generate

NAME_ENTITY = "User link Service"

class UserLinkSocialCases:
    ...
    def add(self, entity: Request) -> dict[str, str]:
        try:
            ...
            if on_db.social_network_id == entity.social_network_id:
