...
from app.db.models import IntermediariaUserProducts as Model
from app.schemas.user_link_product import Request, Update, Response
from app.services.ids import id_generate

NAME_ENTITY = "User link Product"

class UserLinkProductCases:
    ...
    def add(self, entity: Request) -> dict[str, str]:
        try:
            ...
            if on_db.products_id == entity.products_id:
