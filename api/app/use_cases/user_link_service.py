...
from app.db.models import IntermediariaUserServices as Model
from app.schemas.user_link_service import Request, Update, Response
from app.services.ids import id_generate

NAME_ENTITY = "User link Service"

class UserLinkServiceCases:
    ...
    def add(self, entity: Request) -> dict[str, str]:
        try:
            ...
            if on_db.service_id == entity.service_id:
