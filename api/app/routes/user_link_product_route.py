...
from app.schemas.user_link_product import Request, Response, Update
from app.use_cases.user_link_product import UserLinkProductCases as Case

router = APIRouter(prefix="/user_link_product")
