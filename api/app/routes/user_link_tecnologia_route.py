...
from app.schemas.user_link_tecnologia import Request, Response, Update
from app.use_cases.user_link_tecnologia import UserLinkTecnologiaCases as Case

router = APIRouter(prefix="/user_link_tecnologia")
